...
const ShopByBrands = async () => {
  ...
  return (
    <div className="mb-10 lg:mb-20 bg-shop-light-bg p-5 lg:p-7 rounded-md">
      ...
      <div className="grid grid-cols-2 md:grid-cols-4 lg:grid-cols-8 gap-2.5 justify-items-center">
        {brands?.map((brand) => (
          <Link
            key={brand?._id}
      ...
      <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-4 mt-16 p-2  hover:shadow-shop-light-green/20 py-5">
